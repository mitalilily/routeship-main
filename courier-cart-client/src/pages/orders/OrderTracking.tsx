...
const ColorConnector = styled(StepConnector)(() => ({
  ...
  '&.Mui-active .MuiStepConnector-line': { backgroundColor: '#FE6502' },
        ...
        <Grid container spacing={4}>
            ...
            <Paper
              sx={{
                ...
                '&::before': {
                  ...
                  right: 0,
                  height: '4px',
                  background: 'linear-gradient(90deg, #FE6502 0%, #3DD598 100%)',
                  borderRadius: '12px 12px 0 0',
                },
              }}
            >
              <Typography variant="h5" fontWeight={700} color="#FE6502" gutterBottom sx={{ mb: 3 }}>
                Shipment Details
              </Typography>
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            ...
            >
                      ...
                      >
                        <Typography
                          ...
                          sx={{
                            ...
                            color: index <= currentStage || isCancelled ? '#FE6502' : '#4A5568',
                            mt: 1,
                          }}
                        >
                          {stageHistory
              ...
              <Box sx={{ mt: 5 }}>
                <Typography variant="h6" fontWeight={700} color="#FE6502" mb={3}>
                  Tracking History
                </Typography>
                {trackingData.history.map((h, idx) => (
                  <Box key={idx} sx={{ display: 'flex', mb: 3 }}>
                    ...
                    >
                      ...
                      {h.message && (
                        <Typography variant="body2" fontWeight={600} color="#FE6502">
                          {h.message}
                        </Typography>
                      )}
                    </Paper>
