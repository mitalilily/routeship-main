      ...
      <Stack gap={3}>
        ...
        >
          ...
          <Typography variant="body2" sx={{ color: '#6B7280', mt: 0.5, fontSize: '14px' }}>
            Configure thresholds, alerts, and reporting rules with a cleaner RouteShip workflow.
          </Typography>
        ...
        <form onSubmit={handleSubmit}>
          <Stack gap={3}>
            <Box sx={sectionCardSx}>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#FE6502', mb: 1 }}>
                Auto-Acceptance
              </Typography>
              ...
              {formData.autoAcceptEnabled && (
                <Alert
                  ...
                  sx={{
                    ...
                    borderLeft: '4px solid #FE6502',
                    '& .MuiAlert-icon': {
                      color: '#FE6502',
                    },
                  }}
                >
                  <Typography variant="body2" sx={{ fontWeight: 600, color: '#FE6502', mb: 1 }}>
              ...
              <Stack gap={3}>
                ...
                >
                  <Box>
                    <Typography sx={{ fontWeight: 600, color: '#FE6502', mb: 0.5 }}>
                      Enable Auto-Accept
                    </Typography>
                ...
                {formData.autoAcceptEnabled && (
                  <>
                    ...
                    <Box>
                      <Typography
                        sx={{ fontWeight: 600, color: '#FE6502', mb: 1.5, fontSize: '14px' }}
                      >
                        Weight Threshold (kg)
                      </Typography>
                      <TextField
