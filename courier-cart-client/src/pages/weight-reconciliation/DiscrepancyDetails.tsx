    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Stack gap={3}>
          ...
          <CardContent>
            ...
            >
              ...
              <Box>
                ...
                <Typography sx={{ fontWeight: 600, color: '#FE6502' }}>
        ...
        <Card sx={{ boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
          <CardContent>
            <Typography variant="h6" sx={{ fontWeight: 700, color: '#FE6502', mb: 3 }}>
              Weight Comparison
            </Typography>
            <Box
              sx={{
            ...
            >
              <Box>
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, color: '#FE6502' }}>
        ...
        {discrepancy.courier_remarks && (
          <Card sx={shellCardSx}>
            <CardContent>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#FE6502', mb: 2 }}>
                Courier Remarks
              </Typography>
