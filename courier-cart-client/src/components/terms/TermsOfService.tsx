  ...
  return (
    <Container maxWidth="lg">
      ...
      <ul>
        ...
        <li>
          You are responsible for keeping your password secure. RouteShip cannot and will not be
          liable for any loss or damage from your failure to maintain the security of your account
          and password.
        </li>
        <li>
          You may not use the RouteShip service for any illegal or unauthorized purpose nor may you
      ...
      <ul>
        <li>
          ...
          Agreement and the Privacy Policy before becoming a member of RouteShip.
        </li>
        <li>
        ...
        <li>
          RouteShip does not warrant that the service will be uninterrupted, timely, secure, or
          error-free.
        </li>
        <li>
          RouteShip does not warrant that the results obtained from the use of the service will be
        ...
        <li>
          RouteShip shall not be liable for any direct, indirect, incidental, special, or
        ...
        <li>
          By uploading content, you agree to allow other users to view and RouteShip to store and
          review it.
        </li>
        <li>Failure to exercise any right does not constitute a waiver of that right.</li>
        <li>The Terms of Service constitute the entire agreement between you and RouteShip.</li>
        <li>You shall not purchase keywords or domains infringing on RouteShip trademarks.</li>
        <li>RouteShip may refuse or remove any content at its discretion.</li>
        <li>
      ...
      <ul>
        ...
        <li>RouteShip reserves the right to modify or discontinue the Service at any time.</li>
        <li>
          RouteShip shall not be liable for any modification, price change, suspension, or
          discontinuance.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          RouteShip does not permit hosting of the following:
          <ul>
            <li>
