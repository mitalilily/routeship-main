...
function Footer() {
  return (
    <footer><div className="shell footer-top"><div className="footer-brand"><Logo light/><p>The intelligent shipping layer<br/>for modern Indian commerce.</p><a href="mailto:support@routeship.in">support@routeship.in ↗</a></div><div className="footer-links"><div><strong>PLATFORM</strong><a href="/#solution">Overview</a><a href="/tracking">Tracking</a><a href="/rate-calculator">Rate calculator</a><a href="/weight-calculator">Weight calculator</a></div><div><strong>COMPANY</strong><a href="/#problem">About</a><a href="mailto:support@routeship.in">Careers</a><a href="/contact">Contact</a></div><div><strong>RESOURCES</strong><a href="/#faq">Help center</a><a href="/#how">Shipping guide</a><a href="mailto:support@routeship.in">API docs</a></div></div></div><div className="shell footer-bottom"><span>© 2026 ROUTESHIP TECHNOLOGIES</span><div><a href="/">PRIVACY</a><a href="/">TERMS</a></div><a href="#top">BACK TO TOP ↑</a></div></footer>
  );
}
...
function App() {
  ...
  return <Routes><Route path="/" element={<LandingPage/>}/><Route path="/tracking" element={<TrackingPage/>}/><Route path="/rate-calculator" element={<RateCalculatorPage/>}/><Route path="/weight-calculator" element={<WeightCalculatorPage/>}/><Route path="/contact" element={<ContactPage/>}/><Route path="*" element={<Navigate to="/" replace/>}/></Routes>;
}
